...
class PantsCommands:
    ...
    def __init__(
        ...
        command_builder: Optional[PantsCommandBuilder] = None
    ):
    ...
    def pants_fix(self, target: Optional[str] = None) -> CommandResult:
    ...
    def pants_lint(self, target: Optional[str] = None) -> CommandResult:
        """Run linters on code.
    ...
    def pants_check(self, target: Optional[str] = None) -> CommandResult:
    ...
    def pants_test(self, target: Optional[str] = None) -> CommandResult:
        """Run tests.
    ...
    def pants_package(self, target: Optional[str] = None) -> CommandResult:
        """Build packages.
