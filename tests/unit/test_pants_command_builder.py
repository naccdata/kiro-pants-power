...
class TestPantsCommandBuilder:
    ...
    def test_build_command_with_default_target(self) -> None:
    ...
    def test_build_command_with_specific_target(self) -> None:
    ...
    def test_build_command_with_file_target(self) -> None:
    ...
    def test_build_command_with_path_target(self) -> None:
    ...
    def test_validate_target_all_targets(self) -> None:
        """Test validation of :: target."""
        assert self.builder.validate_target("::") is True

    def test_validate_target_directory_with_double_colon(self) -> None:
    ...
    def test_validate_target_specific_target(self) -> None:
    ...
    def test_validate_target_file_with_extension(self) -> None:
    ...
    def test_validate_target_directory_path(self) -> None:
        """Test validation of directory path format."""
        assert self.builder.validate_target("src/python") is True
        assert self.builder.validate_target("common") is True
        assert self.builder.validate_target("src/python/myapp") is True

    def test_validate_target_with_underscores(self) -> None:
    ...
    def test_validate_target_with_hyphens(self) -> None:
    ...
    def test_validate_target_with_wildcards(self) -> None:
        """Test validation of targets with wildcards."""
        assert self.builder.validate_target("src/python::*") is True
        assert self.builder.validate_target("src:*") is True

    def test_validate_target_empty_string(self) -> None:
        """Test validation of empty string."""
        assert self.builder.validate_target("") is False

    def test_validate_target_with_spaces(self) -> None:
    ...
    def test_validate_target_with_special_chars(self) -> None:
        """Test validation rejects targets with invalid special characters."""
        assert self.builder.validate_target("src@python::") is False
        assert self.builder.validate_target("src#python") is False
        assert self.builder.validate_target("src!target") is False

    def test_validate_target_malformed_colon(self) -> None:
    ...
    def test_validate_target_complex_paths(self) -> None:
